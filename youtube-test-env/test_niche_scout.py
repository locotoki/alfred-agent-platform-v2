...
async def run_niche_scout():
    ...
    # Test queries
    queries = ["nursery rhymes", "diy woodworking", "urban gardening", "ai news", "budget travel"]
    ...
    print("\nTop trending niches:")
    print(
        trending_niches.sort_values("score", ascending=False)[
            ["query", "view_sum", "rsv", "score", "niche"]
        ]
    )
