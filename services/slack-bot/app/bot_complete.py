...
import asyncioLFimport loggingLFimport osLFfrom contextlib import asynccontextmanagerLFLFimport redis.asyncio as redisLFfrom fastapi import FastAPI, HTTPExceptionLFfrom slack_bolt.adapter.fastapi.async_handler import AsyncSlackRequestHandlerLFfrom slack_bolt.app.async_app import AsyncAppLFLF# Configure loggingLFlogging.basicConfig(level=logging.INFO)LFlogger = logging.getLogger(__name__)
...
async def lifespan(app: FastAPI):
    ...
    slack_app.client.retry_handlers.append(AsyncRetryHandler(max_retry_count=2))
