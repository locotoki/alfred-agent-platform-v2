...
# Standardized entrypoint script with health check integration for model-router service
...
# model-router specific initialization
# Add any service-specific initialization here

# Handle cleanup when container is stopped
cleanup() {
    echo "Stopping model-router service and healthcheck..."
