"""
Client module initialization for legal-compliance service.
...
async def initialize_clients():
    ...
    logger.info(f"Initializing legal-compliance clients (version {SERVICE_VERSION}, mode: {MIGRATION_MODE})")
