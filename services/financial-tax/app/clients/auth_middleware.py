"""
Authentication middleware for financial-tax service.
...
API_KEY = os.getenv("API_KEY", "financial-tax-key")
PLATFORM_API_KEYS = os.getenv("PLATFORM_API_KEYS", f"financial:{API_KEY}")
