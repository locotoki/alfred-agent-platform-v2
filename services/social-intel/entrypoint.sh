...
# Standardized entrypoint script with health check integration for social-intel service
...
# social-intel specific initialization
# Add any service-specific initialization here

# Handle cleanup when container is stopped
cleanup() {
    echo "Stopping social-intel service and healthcheck..."
