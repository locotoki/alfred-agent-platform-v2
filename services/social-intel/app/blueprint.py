...
class SeedToBlueprint:.
    ...
    async def run(
        self, video_url: Optional[str] = None, niche: Optional[str] = None
        ...
        self.logger.info(
            "SeedToBlueprint workflow completed",
            json_file=filepath,
    ...
    def _generate_simulated_results(
        self, video_url: Optional[str], niche: Optional[str]
    ) -> Dict[str, Any]:
        ...
        if video_url:
            ...
            if "gaming" in video_url.lower():
                ...
                "cook" in video_url.lower()
                or "recipe" in video_url.lower()
                or "food" in video_url.lower()
            ):
