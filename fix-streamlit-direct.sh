#!/bin/bash
# Script to directly override the process_command function in Streamlit UI

echo "Fixing Streamlit UI with direct patch..."

# Create a direct patch script
cat > /home/locotoki/projects/alfred-agent-platform-v2/direct_patch.py << 'EOF'
#!/usr/bin/env python3
"""
...
# Make the patch executable and run it
chmod +x /home/locotoki/projects/alfred-agent-platform-v2/direct_patch.py
python3 /home/locotoki/projects/alfred-agent-platform-v2/direct_patch.py

# Copy the patched file to the container
echo "Copying patched file to container..."
docker cp /home/locotoki/projects/alfred-agent-platform-v2/services/streamlit-chat/streamlit_chat_ui.py ui-chat:/app/
...
echo "When you send a message, it will be processed directly by Ollama."
