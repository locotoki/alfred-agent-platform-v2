...
{format_instructions}
""",
            input_variables=["income", "deductions", "credits", "jurisdiction", "tax_year", "entity_type", "additional_info"],
...
{format_instructions}
""",
            input_variables=["financial_statements", "analysis_type", "period", "industry", "custom_metrics"],
            partial_variables={"format_instructions": self.output_parser.get_format_instructions()}
        )
...
{format_instructions}
""",
            input_variables=["entity_type", "transactions", "jurisdiction", "tax_year", "compliance_areas"],
            partial_variables={"format_instructions": self.output_parser.get_format_instructions()}
        )
...
{format_instructions}
""",
            input_variables=["jurisdiction", "tax_year", "entity_type", "income_level", "special_categories"],
            partial_variables={"format_instructions": self.output_parser.get_format_instructions()}
        )
