"""Simplified unit tests for Financial Tax Agent chains"""
...
class TestTaxCalculationChain:
    ...
    async def test_calculate_success(self, tax_calc_chain):
        ...
        # Mock the entire calculate method
        tax_calc_chain.calculate = AsyncMock(return_value=mock_response)
...
class TestFinancialAnalysisChain:
    ...
    async def test_analyze_success(self, analysis_chain):
        ...
        # Mock the entire analyze method
        analysis_chain.analyze = AsyncMock(return_value=mock_response)
...
class TestComplianceCheckChain:
    ...
    async def test_check_compliance_success(self, compliance_chain):
        ...
        # Mock the entire check_compliance method
        compliance_chain.check_compliance = AsyncMock(return_value=mock_response)
...
class TestRateLookupChain:
    ...
    async def test_lookup_rates_success(self, rate_lookup_chain):
        ...
        # Mock the entire lookup_rates method
        rate_lookup_chain.lookup_rates = AsyncMock(return_value=mock_response)
