...
#### PRD & Validation
- Add PRD markdown template at docs/templates/prd_template.md
- Implement PRD validator script (.github/scripts/validate_prd.py) and add to CI
- Extend Architect-Board with PRD editor pane to create/approve PRDs
- Update Reviewer-agent rule-set to enforce PRD reference and task IDs
- Integrate PRD validation into ci-summary fast-pass and branch protection
- Document PRD workflow in docs/automation_workflow.md
