# YouTube Workflow #1 : Research Scenario Samples
...
<details><summary><em>Advanced ▼</em></summary>

| Parameter | Selection / Value | Notes |
| --- | --- | --- |
| **YouTube Scrape** | ✅ On | Pull channel + video metadata |
| **Reddit Scrape** | ✅ On | Subreddits: r/ZeroWaste, r/Sustainable |
| **Amazon Keywords** | ⬜ Off | (Hidden until toggled) |
| **Budget (credits)** | 150 | Slider: 50–500 |
| **Max Items** | 2 000 posts/videos | Auto-calculated from budget |
| **Date Range** | Last 6 months | Pre-set quick-select |
| **Geo-focus** | United States ✔, UK ✔ | Multi-select dropdown |
| **Sentiment Analysis** | ✅ On | Comments + captions |
| **Export CSV** | ✅ (checked) | Results → `eco_hacks_insights.csv` |
...
| Parameter | Selection / Value | Notes |
| --- | --- | --- |
| **YouTube Scrape** | ✅ On | Top 100 videos + channels |
| **Pinterest Scrape** | ✅ On | Keywords: “keto meals,” “keto snacks” |
| **Budget (credits)** | 120 | → Max items = 1 500 |
| **Date Range** | Last 12 months |  |
| **Geo-focus** | United States ✔, Canada ✔ |  |
| **Amazon Keywords** | ⬜ Off |  |
| **Sentiment Analysis** | ✅ On | Comments + recipe reviews |
| **Export CSV** | ✅ | `keto_busy_parents.csv` |
...
| Parameter | Selection / Value | Notes |
| --- | --- | --- |
| **YouTube Scrape** | ✅ On | Top 75 videos + 30 channels |
| **TikTok Scrape** | ✅ On | Hashtag: #GenZFinance |
| **Podcast Scrape** | ⬜ Off |  |
| **Budget (credits)** | 90 | → Max items = 1 400 |
| **Date Range** | Last 3 months |  |
| **Geo-focus** | United States ✔, UK ✔, Australia ✔ |  |
| **Sentiment Analysis** | ✅ On |  |
| **Export CSV** | ✅ | `genz_finance.csv` |
