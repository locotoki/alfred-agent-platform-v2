...
This module defines the abstract interfaces used throughout the alfred.rag
...
class VectorStore(Protocol):
    ...
    @abstractmethod
    async def add_documents(self, documents: List[Dict[str, Any]], collection_name: str) -> List[str]:
    ...
    @abstractmethod
    async def search(self, query: str, collection_name: str, k: int = 10) -> List[Tuple[Dict[str, Any], float]]:
    ...
    @abstractmethod
    async def create_collection(self, collection_name: str, config: Optional[Dict[str, Any]] = None) -> bool:
