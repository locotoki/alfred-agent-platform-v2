...
class LLMProvider(Protocol):
    ...
    @abstractmethod
    async def generate_stream(self, prompt: str, config: Optional[Dict[str, Any]] = None) -> AsyncIterator[str]:
    ...
    @abstractmethod
    async def chat_completion(self, messages: List[Dict[str, str]], config: Optional[Dict[str, Any]] = None) -> str:
