...
class SlackClient(Protocol):
    ...
    @abstractmethod
    async def update_message(self, channel: str, timestamp: str, text: str, blocks: Optional[List[Dict[str, Any]]] = None) -> Dict[str, Any]:
...
class CommandHandler(Protocol):
    ...
    @abstractmethod
    def handle_command(self, command: Dict[str, Any], ack: Callable[[], None], say: Callable[[str], None]) -> None:
