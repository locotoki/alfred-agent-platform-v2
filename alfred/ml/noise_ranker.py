...
class NoiseRankingModel:
    ...
    def extract_features(self, alert: AlertProtocol, 
    ...
    def predict_noise_score(self, alert: AlertProtocol, 
    ...
    def rank_alerts(self, alerts: List[Tuple[AlertProtocol, Dict]]) -> List[Tuple[AlertProtocol, float]]:
