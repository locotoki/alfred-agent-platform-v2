...
# Create auth functions and tables
cat > auth_setup.sql << EOF
...
cat auth_setup.sql | docker exec -i alfred-agent-platform-v2-supabase-db-1 psql -U postgres -d postgres
