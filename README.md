...
The dependency inventory workflow runs automatically and commits any changes to keep the inventory current with the latest package versions and usage patterns.
