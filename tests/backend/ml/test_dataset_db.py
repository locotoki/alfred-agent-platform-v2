...
from backend.alfred.ml.alert_dataset import load_alert_dataset, _strip_pii, _severity_to_label
    ...
    with tempfile.NamedTemporaryFile(suffix=".db") as tmp:
        ...
        with engine.connect() as conn:
            ...
            test_data = [
                ...
                ("Memory usage at 192.168.1.1 exceeded 90%", "warning", base_date - timedelta(days=1)),
                ("Database connection from 10.0.0.1 failed", "critical", base_date - timedelta(days=2)),
            ...
            for message, severity, created_at in test_data:
                conn.execute(
                    text("INSERT INTO alerts (message, severity, created_at) VALUES (:message, :severity, :created_at)"),
